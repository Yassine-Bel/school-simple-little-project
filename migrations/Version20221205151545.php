 ...
 */
final class Version20221205151545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livre CHANGE empreint_id id_categorie_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livre CHANGE id_categorie_id empreint_id INT NOT NULL');
